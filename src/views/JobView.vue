...
<template>
  <section class="bg-cyan-50">
    <div class="container m-auto py-40 px-6">
      <div class="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
        <main>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md mt-6">
            <h3 class="text-cyan-800 text-lg font-bold mb-6">
              Job Description
            </h3>
        ...
        <aside>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <p class="my-2 bg-cyan-100 p-2 font-bold rounded-md">
          ...
          <div class="bg-white p-6 rounded-lg shadow-md mt-6">
            ...
            <a
              href="add-job.html"
              class="bg-cyan-500 hover:bg-cyan-600 text-white text-center font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline mt-4 block"
              >Edit Job</a
            >
            <button
